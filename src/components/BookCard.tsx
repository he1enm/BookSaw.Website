...
export default function BookCard({
  ...
  const handleClick = (e: React.MouseEvent) => {
    if (isDragging) {
      e.preventDefault(); // oprește navigarea la click dacă tragi slider-ul
      return;
    }
  ...
  return (
    <div
      className="bg-[#efeee8] rounded-lg overflow-hidden shadow-sm flex flex-col text-center h-full cursor-pointer"
      onClick={handleClick}
    >
